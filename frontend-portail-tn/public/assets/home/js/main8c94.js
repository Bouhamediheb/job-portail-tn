...
$offCanvasNav.on("click", "li a, li .menu-expand", function(e) {
    ...
    // Check if parentClass is defined and is a string before using .match()
    if (parentClass && parentClass.match(/\b(menu-item-has-children|has-children|has-sub-menu)\b/) &&
