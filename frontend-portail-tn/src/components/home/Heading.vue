                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-12">
                        <div class="block-banner">
                            <h1 class="heading-banner wow animate__animated animate__fadeInUp">Trouvez le <span
                            ...
                            <div class="banner-description mt-20 wow animate__animated animate__fadeInUp"
                                ...
                                <br class="d-none d-lg-block">vers notre site dans leur recherche de travail.</div>
                            <div class="form-find mt-40 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                <form>
                                    ...
                                    <button class="btn btn-default btn-find font-sm">Recherche</button>
                                </form>
                            </div>
                        </div>
                    </div>
