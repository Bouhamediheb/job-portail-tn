              ...
              <div class="box-padding">
                ...
                <div class="box-profile-image">
                  <div class="img-profile">
                    <img
                      src="assets/dashboard/imgs/page/profile/img-profile.png"
                      alt="jobBox"
                    />
                  </div>
                  <div class="info-profile">
                    <a class="btn btn-default">Télécharger Avatar</a
                  ...
                  <div class="col-lg-12">
                    <div class="form-group mb-30">
                      ...
                      <textarea
                        ...
                        rows="5"
                      >
Nous sommes AliThemes, un groupe créatif et dévoué d'individus qui aiment le développement web presque autant que nous aimons nos clients. Nous sommes une équipe passionnée avec la mission d'atteindre la perfection en design web.</textarea
                      >
                    </div>
                  </div>
                    ...
                    <div class="form-group mb-30">
                      ...
                      <div id="academic-entries">
                        <div
                          ...
                          v-for="(entry, index) in academicEntries"
                          :key="index"
                        >
                          <input
                    ...
                    <div class="form-group mb-30">
                      ...
                      <div id="professional-entries">
                        <div
                          ...
                          v-for="(entry, index) in professionalEntries"
                          :key="index"
                        >
                          <input
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="mt-30 mb-40">
                      <span class="info-icon font-sm color-text-paragraph-2"
                        >Vous pouvez ajouter au maximum 15 skills</span
                      >
                    </div>
                  </div>
