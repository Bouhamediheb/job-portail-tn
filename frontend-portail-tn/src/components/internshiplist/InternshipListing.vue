                ...
                <div class="row">
                  <div class="col-xl-6 col-lg-5">
                    <span class="text-small text-showing">
                      Affichage de <strong>{{ displayedJobs.length }}</strong> de <strong>{{ totalJobs }}</strong> annonces
                    </span>
                  </div>
                    ...
                    <div class="card-grid-2 hover-up" v-for="job in displayedJobs" :key="job.id">
                      <router-link :to="{ name: 'JobDetail', params: { id: job.id } }">
                        <div class="row">
                          ...
                          <div class="col-lg-6 text-start text-md-end pr-60 col-md-6 col-sm-12">
                            <div class="pl-15 mb-15 mt-30">
                              <a v-for="skill in JSON.parse(job.skills)" :key="skill" class="btn btn-grey-small mr-5">{{ skill }}</a>
                            </div>
                          </div>
                        </div>
                        <div class="card-block-info">
                          <h4>{{ job.title }}</h4>
                          <div class="mt-5">
                            <span class="card-briefcase">{{ getWorkplaceType(job.employmentType) }}</span>
            ...
            <div class="sidebar-shadow none-shadow mb-30">
              <div class="sidebar-filters">
                ...
                <div class="filter-block head-border mb-30">
                  <h5>Filtre de recherche <a class="link-reset" href="#">Reset</a></h5>
                </div>
