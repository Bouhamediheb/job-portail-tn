                  ...
                  <li>
                    <a class="dashboard2" href="candidates.html"
                      ><img
                        ...
                        alt="jobBox"
                      /><span class="name">Candidates</span></a
                    >
                  </li>
                  <li>
                    <a class="dashboard2" href="recruiters.html"
                      ><img
                        src="assets/dashboard/imgs/page/dashboard/recruiters.svg"
                        alt="jobBox"
                      /><span class="name">Recruiters</span></a
                    >
                  </li>
                  <li>
                    <a class="dashboard2" href="my-job-grid.html"
                      ><img
                        ...
                        alt="jobBox"
                      /><span class="name">My Jobs</span></a
                    >
                  </li>
                  <li>
                    <a class="dashboard2" href="my-tasks-list.html"
                      ><img
                        src="assets/dashboard/imgs/page/dashboard/tasks.svg"
                        alt="jobBox"
                      /><span class="name">Tasks List</span></a
                    >
                  </li>
                  <li>
                    <a class="dashboard2" href="profile.html"
                      ><img
                        ...
                        alt="jobBox"
                      /><span class="name">My Profiles</span></a
                    >
                  </li>
                  <li>
                    <a class="dashboard2" href="my-resume.html"
                      ><img
                        src="assets/dashboard/imgs/page/dashboard/cv-manage.svg"
                        alt="jobBox"
                      /><span class="name">CV Manage</span></a
                    >
                  </li>
                  <li>
                    <a class="dashboard2" href="settings.html"
                      ><img
                        ...
                        alt="jobBox"
                      /><span class="name">Setting</span></a
                    >
                  </li>
                  <li>
                    <a class="dashboard2" href="authentication.html"
                      ><img
                        src="assets/dashboard/imgs/page/dashboard/authentication.svg"
                        alt="jobBox"
                      /><span class="name">Authentication</span></a
                    >
                  </li>
                  <li>
              ...
              <div class="row">
                  ...
                  <div class="card-style-1 hover-up">
                    ...
                    <div class="card-info">
                      <div class="card-title">
                        <h3>
                          1568<span class="font-sm status up"
                            >25<span>%</span></span
                          >
                        </h3>
                      </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image">
                      <img
                        src="assets/dashboard/imgs/page/dashboard/bank.svg"
                        alt="jobBox"
                      />
                    </div>
                    <div class="card-info">
                      <div class="card-title">
                        <h3>
                          284<span class="font-sm status up"
                            >5<span>%</span></span
                          >
                        </h3>
                      </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image">
                      <img
                        src="assets/dashboard/imgs/page/dashboard/lamp.svg"
                        alt="jobBox"
                      />
                    </div>
                    <div class="card-info">
                      <div class="card-title">
                        <h3>
                          136<span class="font-sm status up"
                            >12<span>%</span></span
                          >
                        </h3>
                      </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image">
                      <img
                        src="assets/dashboard/imgs/page/dashboard/headphone.svg"
                        alt="jobBox"
                      />
                    </div>
                    <div class="card-info">
                      <div class="card-title">
                        <h3>
                          985<span class="font-sm status up"
                            >5<span>%</span></span
                          >
                        </h3>
                      </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image">
                      <img
                        src="assets/dashboard/imgs/page/dashboard/look.svg"
                        alt="jobBox"
                      />
                    </div>
                    <div class="card-info">
                      <div class="card-title">
                        <h3>
                          165<span class="font-sm status up"
                            >15<span>%</span></span
                          >
                        </h3>
                      </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image">
                      <img
                        src="assets/dashboard/imgs/page/dashboard/open-file.svg"
                        alt="jobBox"
                      />
                    </div>
                    <div class="card-info">
                      <div class="card-title">
                        <h3>
                          2356<span class="font-sm status down">- 2%</span>
                        </h3>
                      </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image">
                      <img
                        src="assets/dashboard/imgs/page/dashboard/doc.svg"
                        alt="jobBox"
                      />
                    </div>
                    <div class="card-info">
                      <div class="card-title">
                        <h3>
                          254<span class="font-sm status up"
                            >2<span>%</span></span
                          >
                        </h3>
                      </div>
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                  <div class="card-style-1 hover-up">
                    <div class="card-image">
                      <img
                        src="assets/dashboard/imgs/page/dashboard/man.svg"
                        alt="jobBox"
                      />
                    </div>
                    <div class="card-info">
                      <div class="card-title">
                        <h3>
                          548<span class="font-sm status up"
                            >48<span>%</span></span
                          >
                        </h3>
                      </div>
              ...
              <div class="container">
                <div class="panel-white">
                  <div class="panel-head">
                    ...
                    >
                      <li>
                        <a class="dropdown-item active" href="#">Add new</a>
                      </li>
                  ...
                  <div class="panel-body">
                    <div class="card-style-2 hover-up">
                      <div class="card-head">
                        <div class="card-image">
                          <img
                            src="assets/dashboard/imgs/page/dashboard/img1.png"
                            alt="jobBox"
                          />
                        </div>
                        <div class="card-title">
                          ...
                          ><span class="time-post">3mins ago</span
                          ><span class="location">New York, US</span>
                        </div>
                      </div>
                      <div class="card-tags">
                        <a class="btn btn-tag">Figma</a
                        ><a class="btn btn-tag">Adobe XD</a>
                      </div>
                      <div class="card-price">
                        <strong>$300</strong><span class="hour">/Hour</span>
                      </div>
                    </div>
                    <div class="card-style-2 hover-up">
                      <div class="card-head">
                        <div class="card-image">
                          <img
                            src="assets/dashboard/imgs/page/dashboard/img2.png"
                            alt="jobBox"
                          />
                        </div>
                        <div class="card-title">
                          ...
                          <span class="job-type">Full time</span
                          ><span class="time-post">3mins ago</span
                          ><span class="location">Chicago, US</span>
                        </div>
                      </div>
                      <div class="card-tags">
                        <a class="btn btn-tag">Figma</a
                        ><a class="btn btn-tag">Adobe XD</a
                        ><a class="btn btn-tag">PSD</a>
                      </div>
                      <div class="card-price">
                        <strong>$650</strong><span class="hour">/Hour</span>
                      </div>
                    </div>
                    <div class="card-style-2 hover-up">
                      <div class="card-head">
                        <div class="card-image">
                          <img
                            src="assets/dashboard/imgs/page/dashboard/img3.png"
                            alt="jobBox"
                          />
                        </div>
                        <div class="card-title">
                      ...
                      <div class="card-price">
                        <strong>$1200</strong><span class="hour">/Hour</span>
                      </div>
                    </div>
                    <div class="card-style-2 hover-up">
                      <div class="card-head">
                        <div class="card-image">
                          <img
                            src="assets/dashboard/imgs/page/dashboard/img4.png"
                            alt="jobBox"
                          />
                        </div>
                        <div class="card-title">
                          ...
                          <span class="job-type">Full time</span
                          ><span class="time-post">3mins ago</span
                          ><span class="location">Tokyto, Japan</span>
                        </div>
                      </div>
                      <div class="card-tags">
                        <a class="btn btn-tag">Figma</a
                      ...
                      <div class="card-price">
                        <strong>$580</strong><span class="hour">/Hour</span>
                      </div>
                    </div>
                    <div class="card-style-2 hover-up">
                      <div class="card-head">
                        <div class="card-image">
                          <img
                            src="assets/dashboard/imgs/page/dashboard/img5.png"
                            alt="jobBox"
                          />
                        </div>
                        <div class="card-title">
                          ...
                          <span class="job-type">Full time</span
                          ><span class="time-post">3mins ago</span
                          ><span class="location">Ha Noi, Vietnam</span>
                        </div>
                      </div>
                      <div class="card-tags">
                        <a class="btn btn-tag">Figma</a
                      ...
                      <div class="card-price">
                        <strong>$1500</strong><span class="hour">/Hour</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="panel-body">
                    <div class="card-style-3 hover-up">
                      <div class="card-image online">
                        <img
                          src="assets/dashboard/imgs/page/dashboard/avata1.png"
                          alt="jobBox"
                        />
                      </div>
                      <div class="card-title">
                        <h6>Robert Fox</h6>
                        <span class="job-position">UI/UX Designer</span>
                      </div>
                      ...
                      <div class="card-rating">
                        ...
                        <img
                          ...
                          alt="jobBox"
                        />
                        <span class="font-xs color-text-mutted"> (65)</span>
                      </div>
                    </div>
                    <div class="card-style-3 hover-up">
                      <div class="card-image online">
                        <img
                          src="assets/dashboard/imgs/page/dashboard/avata2.png"
                          alt="jobBox"
                        />
                      </div>
                      <div class="card-title">
                        <h6>Cody Fisher</h6>
                        <span class="job-position">Network Engineer</span>
                      </div>
                      <div class="card-location">
                        <span class="location">New York, US</span>
                      </div>
                    ...
                    <div class="card-style-3 hover-up">
                      <div class="card-image online">
                        <img
                          src="assets/dashboard/imgs/page/dashboard/avata3.png"
                          alt="jobBox"
                        />
                      </div>
                      <div class="card-title">
                        <h6>Jane Cooper</h6>
                        <span class="job-position">Content Manager</span>
                      </div>
                      <div class="card-location">
                        <span class="location">Chicago, US</span>
                      </div>
                    ...
                    <div class="card-style-3 hover-up">
                      <div class="card-image online">
                        <img
                          src="assets/dashboard/imgs/page/dashboard/avata4.png"
                          alt="jobBox"
                        />
                      </div>
                      <div class="card-title">
                    ...
                    <div class="card-style-3 hover-up">
                      <div class="card-image online">
                        <img
                          src="assets/dashboard/imgs/page/dashboard/avata5.png"
                          alt="jobBox"
                        />
                      </div>
                      <div class="card-title">
                        <h6>Floyd Miles</h6>
                        <span class="job-position">NodeJS Dev</span>
                      </div>
                      <div class="card-location">
                        <span class="location">Chicago, US</span>
                      </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card-style-4 hover-up">
                          <div class="d-flex">
                            ...
                            <div class="card-title">
                              ...
                              />
                              <img
                                src="assets/dashboard/imgs/page/dashboard/star-none.svg"
                                alt="jobBox"
                              />
                              <img
                                src="assets/dashboard/imgs/page/dashboard/star-none.svg"
                          ...
                          <div class="card-location d-flex">
                            <span class="location">Red, CA</span
                            ><span class="jobs-number">25 Open Jobs</span>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 pr-5 pl-5">
                      ...
                      <div class="col-lg-6 col-md-6 pr-5 pl-5">
                        <div class="card-style-4 hover-up">
                          ...
                          <div class="card-location d-flex">
                            <span class="location">Boston, US</span
                            ><span class="jobs-number">25 Open Jobs</span>
                          </div>
                        </div>
                      </div>
